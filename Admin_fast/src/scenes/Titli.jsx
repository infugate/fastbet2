...
function Contact() {
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/admin/getPapus`)
      .then(response => {
  ...
  const columns = [
    ...
    { field: "totalBets", headerName: "Total Bets", flex: 1 },
  ...
  return (
    <Box m="0.5rem 1rem">
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        <Header title="Papu Bets" subtitle="List of All User Bets" />
