...
//     { id: 4, pointsToplay: 10, profit: 950, subtitle: "JODI PANNA", image: matkaImage },
//     { id: 4, pointsToplay: 10, profit: 950, subtitle: "TRIPPLE PANNA", image: matkaImage },
//   ];
...
//           <GridContainer>
//             {items.map((item) => (
//               <Link to={`/dashboard/bidpage/${gameName}/${item.subtitle}/${item.pointsToplay}/${item.profit}`} key={item.id}>
//                 <Card
//                   style={{
//                     pointerEvents: bidStatus === "Close" && (item.subtitle !== "SINGLE PANNA" && item.subtitle !== "TRIPPLE PANNA") ? "none" : "auto",
//                     opacity: bidStatus === "Close" && (item.subtitle !== "SINGLE PANNA" && item.subtitle !== "SINGLE DIGIT" && item.subtitle !== "TRIPPLE PANNA") ? 0.5 : 1,
//                   }}
//                 >
...
const Play = () => {
  ...
  const items = [
    ...
    { id: 2, pointsToplay: 10, profit: 950, subtitle: "JODI DIGIT", image: matkaImage },
    { id: 3, pointsToplay: 10, profit: 95, subtitle: "SINGLE PANNA", image: matkaImage },
    { id: 3, pointsToplay: 10, profit: 95, subtitle: "DOUBLE PANNA", image: matkaImage },
    { id: 4, pointsToplay: 10, profit: 950, subtitle: "JODI DIGIT", image: matkaImage },
    { id: 4, pointsToplay: 10, profit: 950, subtitle: "TRIPPLE PANNA", image: matkaImage },
  ];
